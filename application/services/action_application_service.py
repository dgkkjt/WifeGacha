...
class ActionApplicationService:
    ...
    async def update_action_count(self, user_group: UserGroup, character: Character, action_type: ActionType, increase: int = 1) -> None:
        ...
        setattr(stats, field_name, getattr(stats, field_name) + increase)
